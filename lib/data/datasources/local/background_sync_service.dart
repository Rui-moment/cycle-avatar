...
class BackgroundSyncService {
  ...
  StreamSubscription<MockConnectivityResult>? _connectivitySubscription;
  
  bool _isInitialized = false;
  bool _isBackgroundSyncEnabled = true;
  bool _isOnline = false;
  MockConnectivityResult _currentConnectivity = MockConnectivityResult.none;
  ...
  void _onConnectivityChanged(MockConnectivityResult result) async {
  ...
  Future<bool> _performNetworkHealthCheck() async {
    if (_currentConnectivity == MockConnectivityResult.none) {
      return false;
    }
...
class NetworkStatus {
  final bool isOnline;
  final MockConnectivityResult connectivityResult;
  ...
  String get connectionType {
    switch (connectivityResult) {
      case MockConnectivityResult.wifi:
        return 'WiFi';
      case MockConnectivityResult.mobile:
        return 'Mobile Data';
      case MockConnectivityResult.ethernet:
        return 'Ethernet';
      case MockConnectivityResult.none:
  ...
  bool get isMeteredConnection {
    return connectivityResult == MockConnectivityResult.mobile;
  }
  ...
  bool get isReliableForSync {
    return isOnline && (
      ...
      connectivityResult == MockConnectivityResult.ethernet
    );
  }
}
