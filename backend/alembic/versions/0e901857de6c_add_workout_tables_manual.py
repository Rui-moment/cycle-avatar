...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_workout_sessions_id"), "workout_sessions", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "exercise_id", sa.String(36), sa.ForeignKey("exercises.id"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_fatigue_events_id"), "fatigue_events", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_fatigue_events_muscle_group_id"),
        "fatigue_events",
        ["muscle_group_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_fatigue_events_workout_session_id"),
        "fatigue_events",
        ["workout_session_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_recovery_states_id"), "recovery_states", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_recovery_states_muscle_group_id"),
        "recovery_states",
        ["muscle_group_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_recovery_states_user_id"), "recovery_states", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_pr_records_user_id"), "pr_records", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_pr_records_exercise_id"), "pr_records", ["exercise_id"], unique=False
    )
