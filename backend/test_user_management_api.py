...
class UserManagementAPITester:
    ...
    def test_user_registration(self) -> bool:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/auth/register", json=self.test_user_data
            )
            ...
            if response.status_code == 201:
                ...
                print(
                    f"❌ Registration failed: {response.status_code} - {response.json()}"
                )
                return False
    ...
    def test_get_user_profile(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"❌ Profile retrieval failed: {response.status_code} - {response.json()}"
                )
                return False
    ...
    def test_update_user_profile(self) -> bool:
        ...
        try:
            ...
            response = requests.put(
                f"{self.base_url}/users/me", json=update_data, headers=headers
            )
    ...
    def test_change_password(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"❌ Password change failed: {response.status_code} - {response.json()}"
                )
                return False
    ...
    def test_password_reset_request(self) -> bool:
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/auth/password-reset-request", json=reset_request
            )
            ...
            if response.status_code == 200:
                ...
                print(
                    f"❌ Password reset request failed: {response.status_code} - {response.json()}"
                )
                return False
    ...
    def test_password_reset(self, reset_token: str) -> bool:
        ...
        try:
            reset_data = {"token": reset_token, "new_password": "ResetPassword123!"}

            response = requests.post(
                f"{self.base_url}/auth/password-reset", json=reset_data
            )
            ...
            if response.status_code == 200:
                ...
                print(
                    f"❌ Password reset failed: {response.status_code} - {response.json()}"
                )
                return False
    ...
    def test_user_statistics(self) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(
                    f"❌ User statistics failed: {response.status_code} - {response.json()}"
                )
                return False
    ...
    def run_all_tests(self):
        ...
        if passed == total_tests:
            ...
            print(
                "✅ User registration, login, profile management, and password reset are working correctly."
            )
        else:
